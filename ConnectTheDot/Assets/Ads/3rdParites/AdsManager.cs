...
public class AdsManager : MonoBehaviour
{
    ...
    [SerializeField] private string InterstitialAdUnitIdGeneric = "99110cbd31b343ff";
    [SerializeField] private string RewardedAdUnitIdGeneric = "b94ccc59e55df589";
    [SerializeField] private string BannerAdUnitId = "acae9bdb88d2c3f0";
    [SerializeField] private string AppOpenAdUnitId = "";
    [SerializeField] private string RecID = "b59d0ccb1420f6f0";
    ...
    private void ShowPopUp()
    {
       ...
       InitializeBannerAds();
        CustomAdsEventsforSpacificMode();
    ...
    void CustomAdsEventsforSpacificMode()
    {
        ForSpecialInterstial.InerstitialcheckAction += ShowInterstitial;
        ForSpecialInterstial.BannercheckAction += ShowBannerr;
    ...
    {
        ShowInterstitialWithoutConditions("CustomAdsEventsforSpacificMode");
    }
    private void ShowBannerr()
    {
        ShowBanner();
    }
